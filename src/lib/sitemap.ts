...
export async function buildSitemapUrls(): Promise<SitemapUrl[]> {
  ...
  const urls: SitemapUrl[] = [
    ...
    { loc: `${SITE_URL}/guides/how-to-join-whatsapp-groups-safely`, lastmod: today, changefreq: "monthly", priority: "0.8" },
    { loc: `${SITE_URL}/guides/whatsapp-community-vs-group`, lastmod: today, changefreq: "monthly", priority: "0.8" },
    { loc: `${SITE_URL}/guides/how-to-avoid-whatsapp-scams`, lastmod: today, changefreq: "monthly", priority: "0.8" },
    { loc: `${SITE_URL}/guides/whatsapp-group-admin-guidelines`, lastmod: today, changefreq: "monthly", priority: "0.8" },
    { loc: `${SITE_URL}/guides/whatsapp-groups-country-joining-guide`, lastmod: today, changefreq: "monthly", priority: "0.8" },
    { loc: `${SITE_URL}/safety`, changefreq: "monthly", priority: "0.7" },
    { loc: `${SITE_URL}/moderation-policy`, changefreq: "monthly", priority: "0.7" },
    { loc: `${SITE_URL}/editorial-policy`, changefreq: "monthly", priority: "0.7" },
    { loc: `${SITE_URL}/how-reporting-works`, changefreq: "monthly", priority: "0.7" },
